    ...
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow-md">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a
            href="/"
            className="flex items-center justify-center mb-1 text-2xl font-semibold text-gray-900 dark:text-white"
          >
          ...
          <div className="flex items-center lg:order-3">
            <Link
              to="/signin"
              className="text-gray-700 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg  px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
            >
              Sign In
            </Link>
          ...
          <form className=" lg:order-2 w-80">
            <label
              for="default-search"
